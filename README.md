...
```
cd "Github-code-reviewer\infra\terraform"
```
...
1. Go to https://github.com/nishan129/Github_code_reviewer
...
```
notepad "Github-code-reviewer\infra\k8s\configmap.yaml"
```
...
```
notepad "Github-code-reviewer\infra\k8s\secret.yaml"
```
...
```
cd "Github-code-reviewer\infra\k8s"
```
...
```
kubectl create configmap prometheus-config --from-file=prometheus.yml="Github-code-reviewer\monitoring\prometheus.yml" -n monitoring --dry-run=client -o yaml | kubectl apply -f -
```
...
4. Navigate to `D:\Github-code-reviewer\monitoring\grafana-dashboard.json`
...
```
cd "D:\Github\ai-code-reviewer\infra\terraform"
...
Shut down everything (stop AWS charges):
  cd "D:\Github-code-reviewer\infra\terraform"
